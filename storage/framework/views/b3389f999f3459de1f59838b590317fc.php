                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="time" class="form-control" id="duration" name="duration" value="<?php echo e(old('duration')); ?>">
                                        </div>

                                        <!-- Start Time -->
                                        <div class="mb-3">
                                            <label for="start_time" class="form-label">Start Time</label>
                                            <input type="time" class="form-control" id="start_time" name="start_time" value="<?php echo e(old('start_time')); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="description_en" name="description_en" value="<?php echo e(old('description_en')); ?>">
                                        </div>

                                        <!-- Description (Arabic) -->
                                        <div class="mb-3">
                                            <label for="description_ar" class="form-label">Description (Arabic)</label>
                                            <input type="text" class="form-control" id="description_ar" name="description_ar" value="<?php echo e(old('description_ar')); ?>">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="details_en" name="details_en" value="<?php echo e(old('details_en')); ?>">
                                        </div>

                                        <!-- Details (Arabic) -->
                                        <div class="mb-3">
                                            <label for="details_ar" class="form-label">Details (Arabic)</label>
                                            <input type="text" class="form-control" id="details_ar" name="details_ar" value="<?php echo e(old('details_ar')); ?>">
                                        </div>

                                        <!-- End Time -->
                                        <div class="mb-3">
                                            <label for="end_time" class="form-label">End Time</label>
                                            <input type="time" class="form-control" id="end_time" name="end_time" value="<?php echo e(old('end_time')); ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="country_id" name="country_id">
                                        <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($country->id); ?>"><?php echo e($country->name['en']); ?>, <?php echo e($country->name['ar']); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\Volgato2\resources\views/dashboard/service/create.blade.php ENDPATH**/ ?>