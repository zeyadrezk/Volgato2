                ...
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="nav-submenu menu-content" style="display: <?php echo e(prefixBlock('/products')); ?>;">
                            <li><a href="<?php echo e(route('products.index')); ?>" class="<?php echo e(routeActive('index')); ?>">Products</a></li>
                            <li><a href="<?php echo e(url('admin/categories')); ?>" class="<?php echo e(routeActive('index')); ?>">categories</a></li>

                        </ul>

                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title <?php echo e(prefixActive('/pages')); ?>" href="javascript:void(0)">
                            <i class=" fa fa-bookmark-o"></i><span> Pages</span>
                        </a>
                        <ul class="nav-submenu menu-content" style="display: <?php echo e(prefixBlock('/pages')); ?>;">
                            <li><a href="<?php echo e(url('admin/pages')); ?>" class="<?php echo e(routeActive('index')); ?>">Static pages</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title <?php echo e(prefixActive('/page-layout')); ?>" href="javascript:void(0)"><i data-feather="layout"></i><span>Page layout</span></a>
                        <ul class="nav-submenu menu-content"  style="display: <?php echo e(prefixBlock('/page-layout')); ?>;">
                            <li><a href="<?php echo e(route('boxed-layout')); ?>" class="<?php echo e(routeActive('boxed-layout')); ?>">Boxed</a></li>
                            <li><a href="<?php echo e(route('layout-rtl')); ?>" class="<?php echo e(routeActive('layout-rtl')); ?>">RTL</a></li>
                            <li><a href="<?php echo e(route('layout-dark')); ?>" class="<?php echo e(routeActive('layout-dark')); ?>">Dark</a></li>
                            <li><a href="<?php echo e(route('footer-light')); ?>" class="<?php echo e(routeActive('footer-light')); ?>">Footer Light</a></li>
                            <li><a href="<?php echo e(route('footer-dark')); ?>" class="<?php echo e(routeActive('footer-dark')); ?>">Footer Dark</a></li>
                            <li><a href="<?php echo e(route('footer-fixed')); ?>" class="<?php echo e(routeActive('footer-fixed')); ?>">Footer Fixed</a></li>
                        </ul>
                    </li>
                    <li class="sidebar-main-title">
                        <div>
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title <?php echo e(prefixActive('/knowledgebase')); ?>" href="javascript:void(0)"><i data-feather="database"></i><span>Knowledgebase</span></a>
                        <ul class="nav-submenu menu-content" style="display: <?php echo e(prefixBlock('/knowledgebase')); ?>;">
                            <li><a href="<?php echo e(route('knowledgebase')); ?>" class="<?php echo e(routeActive('knowledgebase')); ?>">Knowledgebase</a></li>
                            <li><a href="<?php echo e(route('knowledge-category')); ?>" class="<?php echo e(routeActive('knowledge-category')); ?>">Knowledge category</a></li>
                            <li><a href="<?php echo e(route('knowledge-detail')); ?>" class="<?php echo e(routeActive('knowledge-detail')); ?>">Knowledge detail</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="nav-link menu-title link-nav <?php echo e(routeActive('support-ticket')); ?>" href="<?php echo e(route('support-ticket')); ?>"><i data-feather="headphones"></i><span>Support Ticket</span></a>
                    </li>
                </ul>
            </div>
...
<?php /**PATH /home/hesabatt/public_html/resources/views/layouts/admin/partials/sidebar.blade.php ENDPATH**/ ?>