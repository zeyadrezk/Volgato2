      ...
      <ul class="nav-menus">
        ...
        <li class="onhover-dropdown">
          ...
          <li class="onhover-dropdown p-0">
              <a href="<?php echo e(route('admin.logout')); ?>" class="btn btn-primary-light" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
...
<?php /**PATH /home/hesabatt/public_html/resources/views/layouts/admin/partials/header.blade.php ENDPATH**/ ?>