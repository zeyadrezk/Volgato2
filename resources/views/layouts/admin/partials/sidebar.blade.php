                ...
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('/products') }};">
                            <li><a href="{{ route('products.index') }}" class="{{ routeActive('index') }}">Products</a></li>
                            <li><a href="{{url('admin/categories') }}" class="{{ routeActive('index') }}">categories</a></li>

                        </ul>

                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title {{ prefixActive('/pages') }}" href="javascript:void(0)">
                            <i class=" fa fa-bookmark-o"></i><span> Pages</span>
                        </a>
                        <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('/pages') }};">
                            <li><a href="{{url('admin/pages')}}" class="{{ routeActive('index') }}">Static pages</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
